    ...
    public class TextureArrayManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Generate Texture2DArray"))
            {
                ...
                EditorUtility.DisplayProgressBar(EditorGUIHelper.GetProgressBarTitle("Texture Array Manager"), "Creating tex2d array ...", 0f);
                ...
                {
                    EditorUtility.DisplayProgressBar(EditorGUIHelper.GetProgressBarTitle("Texture Array Manager"), "Saving assets ...", .5f);
                ...
                else
                {
                    ...
                    EditorUtility.DisplayProgressBar(EditorGUIHelper.GetProgressBarTitle("Texture Array Manager"), "Updating Database ...", .9f);
                ...
                EditorUtility.DisplayProgressBar(EditorGUIHelper.GetProgressBarTitle("Texture Array Manager"), "Completed!", 1f);
